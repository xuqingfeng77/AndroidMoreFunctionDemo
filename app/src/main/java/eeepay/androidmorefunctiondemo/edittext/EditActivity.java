package eeepay.androidmorefunctiondemo.edittext;
...
/**
 *@author  :xqf
 *@date    :2017/11/2 15:13
 *@desc    :当布局不足够一页面时，自动挤推布局，可以实现滚动，如果不处理是无法滚动scrollview，微信和QQ都可以考虑这方面体验
 *@update  :
 */
public class EditActivity extends AppCompatActivity implements View.OnLayoutChangeListener{
